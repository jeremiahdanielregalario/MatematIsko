-- Expand the existing Unit II note without changing its identity or ordering.
-- Source: notes/math146-unit2-differential-geometry.md and the supplied PDF/Typst.
-- Publish the 31 PNG illustrations to the dedicated bucket before applying.
DO $migration$
BEGIN
  UPDATE public.course_notes
  SET content = $math146$# Math 146: Differential Geometry, Unit II
...
![Polar frame at a point on the unit circle](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig1.png)
...
![Radial and angular directions in the plane](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig2.png)
...
![Cylindrical frame and the vertical direction](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig3.png)
...
![Elevation angle in spherical coordinates](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig4.png)

![Spherical frame compared with cylindrical directions](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig5.png)
...
![A tangent vector and its change along a curve](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig7.png)
...
![The inward curvature vector on a circle](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig6.png)
...
![Comparison of a curve with its local circle of curvature](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig8.png)
...
![A circular helix and its axial direction](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig8.5.png)
...
![Principal normal and tangent along a curve](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig9.png)
...
![The three directions of the Frenet frame](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig10.png)
...
![A constant binormal determines a fixed plane](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig11.png)

![The displacement from a fixed point stays perpendicular to the binormal](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig12.png)
...
![Tangent and principal normal lie in the curve's plane](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig13.png)

![The binormal is perpendicular to that plane](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig14.png)
...
![The two possible normal orientations](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig15.png)

![Continuity prevents switching between the two orientations](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig16.png)
...
![A planar curve with constant positive curvature lies on a circle](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig17.png)
...
![Velocity has length equal to speed and points along the unit tangent](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig18.png)
...
![Coordinate patches on the sphere](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig19.png)
...
![A graph over a region of the coordinate plane](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig20.png)
...
![Examples of level sets](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig21.png)
...
![A level set represented locally as a graph](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig22.png)
...
![A nonzero partial derivative lets us solve for one coordinate](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig22.5.png)
...
![The geographical patch and the omitted seam](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig23.png)
...
![A parameter domain mapped to a surface patch](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig23.5.png)

![Coordinate lines become curves on the surface](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig24.png)
...
![Varying the first coordinate with the second fixed](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig25.png)
...
![Varying the second coordinate with the first fixed](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig26.png)
...
![Partial velocities at a point of the patch](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig27.png)
...
![The two independent directions supplied by a regular patch](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit2-notes-20260916/146_unit2_fig28.png)
...
$math146$
  WHERE id = 'e6c40a16-e845-41ed-83c2-dabd361cb794'
    AND course_id = '609dc463-1524-494d-bf0f-91859a2e4cf4';
  IF NOT FOUND THEN
    RAISE EXCEPTION 'Expected Math 146 Unit II note is missing; refusing to create a duplicate';
  END IF;
END
$migration$;
