-- ============================================================================
-- Seed: MATH 126 Real Analysis - Unit II notes (Lebesgue spaces and the
-- Young, Holder, and Minkowski inequalities), matching the stored
-- course-note Markdown format.
-- ============================================================================
...
values
  (
    'e2f6c7d8-8a9b-4c2d-9e4f-5a6b7c8d9e0f',
    'c0000000-0000-4000-8000-000000000004',
    'Unit II: Lebesgue Spaces ($L^p$ Spaces)',
$BODY$# Math 126: Real Analysis — Unit II
...
This proves $L^q(\Omega) \subseteq L^p(\Omega)$ together with the norm inequality (1). ∎$BODY$,
    2
  )
