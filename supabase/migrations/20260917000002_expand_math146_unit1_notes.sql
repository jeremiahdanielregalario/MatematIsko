-- Expand the existing Unit I note; preserve its stable identity, title and order.
-- Source: notes/math146-unit1-differential-geometry.md and the supplied PDF/Typst.
-- Upload the 28 illustrations to the dedicated bucket before applying.
DO $migration$
BEGIN
  UPDATE public.course_notes
  SET content = $math146$# Math 146: Differential Geometry, Unit I
...
![Examples of intervals in dictionary order](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig1.png)
...
![Open balls in the standard topology](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig2.png)

![Comparing the dictionary and standard topologies](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig3.png)
...
![An ambient open set produces an open set in a subspace](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig4.png)

![The topology of a line viewed inside the plane or space](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig5.png)
...
![A ball fitting inside an open set](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig6.png)
...
![The corresponding ball criterion in a subspace](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig7.png)

![First example of relative openness](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig8.png)

![Second example of relative openness](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig9.png)
...
![A map and its component functions](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig10.png)
...
![A tangent vector has both a base point and a vector part](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig11.png)

![Vectors based at a fixed point](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig12.png)

![Different base points give different tangent spaces](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig13.png)
...
![Differentiating a function along a line through the base point](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig14.png)
...
![Components of a tangent vector as coordinate derivatives](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig15.png)
...
![A vector field acting on a smooth function](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig16.png)
...
![Degree cases for wedging with a zero form](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig20.png)
...
![The coefficient-preserving maps between fields, one-forms, and two-forms](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig21.png)
...
![Exterior differentiation connects gradient, curl, and divergence](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig22.png)
...
![A smooth curve on an open interval](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig23.png)

For a non-open interval, smoothness means that $\alpha$ extends to a smooth curve on an open interval containing $I$.

![Extending a curve beyond the endpoints of its interval](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig24.png)
...
![Velocity is based at the current point of the curve](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig25.png)
...
![Changing from the original parameter to arc length](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig26.png)
...
![Differentiating a field while its base point moves along the curve](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig27.png)

![The ambient position vector field](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig28.png)

![The position vector field restricted along a curve](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig29.png)
...
![Differentiating the inner product along a curve](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig30.png)
...
![A line realizes the tangent direction at the chosen base point](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/math146-unit1-notes-20260917/146_unit1_fig31.png)
...
$math146$
  WHERE id = 'd6c40a16-e845-41ed-83c2-dabd361cb794'
    AND course_id = '609dc463-1524-494d-bf0f-91859a2e4cf4';
  IF NOT FOUND THEN
    RAISE EXCEPTION 'Expected Math 146 Unit I note is missing; refusing to create a duplicate';
  END IF;
END
$migration$;
