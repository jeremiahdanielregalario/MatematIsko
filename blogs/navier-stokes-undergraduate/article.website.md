...
![A circular velocity field with a particle moving upward at the right side of a circle and accelerating inward.](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/navier-stokes-blog-20260916/velocity-field.png)
...
![Conceptual cross-section showing an oceanic plate descending beneath an overriding plate, with the mantle wedge between them.](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/navier-stokes-blog-20260916/mantle-wedge.png)
...
![Three smooth curves become taller and narrower while each keeps the same integral of its square.](https://wsbnsxtknjrviwfnvqbz.supabase.co/storage/v1/object/public/navier-stokes-blog-20260916/bounded-energy-peaks.png)
