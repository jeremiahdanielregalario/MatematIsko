...
ax.set_title('Fixed arrows, changing particle velocity',loc='left',fontsize=17,pad=22,fontweight='bold')
...
ax.text(6.7,-1.95,'Mantle wedge',fontsize=16,fontweight='bold')
ax.text(6.7,-2.55,'Slow deformation over\ngeological time',fontsize=10)
