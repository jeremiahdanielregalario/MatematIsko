  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <Reveal>
        <Card className="text-center">
          <CardHeader className="items-center">
            <div className="mb-2 grid size-16 animate-pop-in place-items-center rounded-full bg-brand-900 text-brand-50 dark:bg-brand-800">
      ...
      <div className="grid grid-cols-3 gap-4">
        <Reveal delay={100}>
          <ProgressCard label="Correct" value={summary.correct} className="h-full" />
        </Reveal>
        <Reveal delay={175}>
          <ProgressCard label="Incorrect" value={summary.incorrect} className="h-full" />
        </Reveal>
        <Reveal delay={250}>
          <ProgressCard label="Not sure" value={summary.unsure} className="h-full" />
        </Reveal>
      </div>
